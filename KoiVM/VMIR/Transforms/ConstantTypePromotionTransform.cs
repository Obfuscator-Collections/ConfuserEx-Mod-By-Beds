...
namespace KoiVM.VMIR.Transforms
{
	public class ConstantTypePromotionTransform : ITransform
	{
		...
		private static IIROperand PromoteConstant(IRConstant value, ASTType type)
		{
			...
			{
				case ASTType.I8:
					result = ConstantTypePromotionTransform.PromoteConstantI8(value);
					break;
				case ASTType.R4:
					result = ConstantTypePromotionTransform.PromoteConstantR4(value);
					break;
				case ASTType.R8:
					result = ConstantTypePromotionTransform.PromoteConstantR8(value);
					break;
				default:
					result = value;
					break;
